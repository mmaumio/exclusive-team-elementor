...
class Exad_Team_Carousel extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'DC Team Carousel', 'exclusive-team-elementor' );
	}
	...
	protected function _register_controls() {
		...
		*/
		$team_repeater->add_control(
			...
			[
				'label' => __( 'Team Member Avatar', 'exclusive-team-elementor' ),
		...
		$team_repeater->add_control(
			...
			[
				...
				'default' => esc_html__( 'Member Name', 'exclusive-team-elementor' ),
			]
		);
		...
		$team_repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Designation', 'exclusive-team-elementor' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'label'          => esc_html__( 'Members Each Row', 'exclusive-team-elementor' ),
				'label_block'    => true,
		...
		$this->add_control(
			...
			[
				'type'      => Controls_Manager::SELECT,
				'label'     => esc_html__( 'Members to Scroll', 'exclusive-team-elementor' ),
				'label_block'    => true,
				'options'   => $slides_per_view,
				'default'   => '1',
			]
		...
		*/
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Carousel Styles', 'exclusive-team-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'description' => __( 'Some of the below options will show up based on the Preset. ie. Social Section', 'exclusive-team-elementor' ),
				'default' => '-circle',
				'options' => [
	...
	protected function render() {
		...
		$this->add_render_attribute( 
				...
				[ 
					...
					'data-team-preset' => esc_attr( $team_preset ),
					'data-carousel-nav' => esc_attr( $carousel_nav ),
					'data-infinite' => esc_attr( ( $settings['exad_team_loop'] == 'yes' ) ? true : false ),
					'data-slidestoshow' => esc_attr( $settings['exad_team_per_view'] ),
					'data-slidestoscroll' => esc_attr( $settings['exad_team_slides_to_scroll'] ),
					'data-autoplay' => esc_attr( ( $settings['exad_team_autoplay'] == 'yes' ) ? true : false ),
					'data-autoplayspeed' => esc_attr( ( $settings['exad_team_autoplay_speed'] == 'yes' ) ? true : false ),
		    		'data-speed' => esc_attr( $settings['exad_team_transition_duration'] ),
		    		'data-pauseonhover' => esc_attr( ( $settings['exad_team_pause'] == 'yes' ) ? true : false ),
				]
			);
				...
				<div class="exad-team-carousel<?php echo esc_attr( $team_preset ); ?>-inner">
	            	<div class="exad-team-member<?php echo esc_attr( $team_preset ); ?>">
	                	<div class="exad-team-member-thumb">
							...
							<?php endif; ?>
	                  		<img src="<?php echo esc_url($team_carousel_image_url); ?>" class="circled" alt="?php echo esc_attr( $settings['exad_team_carousel_name'] ); ?>">
	                	</div>
	                	<div class="exad-team-member-content">
		                	...
		                	<p class="exad-team-member-about">
			                	<?php echo esc_html( $member['exad_team_carousel_description'] ); ?>
			                </p>
